...
Additionally, we have included a section in the paper [[1]](https://arxiv.org/abs/2104.05746) evaluating the performance of the proposed approach againts topological changes in the 2000-bus system. Thus, in the following link, you can find information about the corridor lines and the ones we used in our experiments. More details are given in the paper. [Corridor Lines](https://drive.google.com/file/d/10u3ZnJEqvUjJOdiFlJ0JwOsuHgIka87u/view?usp=sharing)
